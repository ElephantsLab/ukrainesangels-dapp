      ...
      <div class="container">
        <div class="cards-help-wrapper">
          <div class="card card-help card-help-1">
            ...
            <a href="https://ukrainesangels.com/InfoPageOne" class="btn btn-yellow">Information for Asylum-Seekers</a>
          </div>
          <div class="card card-help card-help-2">
            <p class="title">If you want help</p>
            <a href="https://ukrainesangels.com/InfoPageTwo" class="btn btn-yellow">Become an angel</a>
          </div>
        </div>
      </div>
    </section>
